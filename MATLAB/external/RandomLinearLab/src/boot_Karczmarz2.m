function x = boot_Karczmarz2(A,b,options)
sA = size(A);
%[options.pna,options.na]= row_weight_prob2(A);
%options=boot_random_weighted_selection(options,sA(1)); %expensive step.
options.name= 'Kaczmarz2';
