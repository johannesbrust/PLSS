function [ xk, nck, outs ] = plss_RW1( x, A, b, opts )
%PLSS_RW1: Projected linear systems solver Algorithm 1 (Recursive) with
% inverse weighting matrix (W). This version (i.e., 1 explicitly computes 
% the residuals instead of updating them)
%
